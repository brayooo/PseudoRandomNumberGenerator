...
class LinerCongruentialTab(BaseTab):
    """
    Clase para la pestaña del método lineal congruencial en la interfaz de usuario.
    Hereda de BaseTab y agrega campos de entrada específicos para este método.
    """
    def __init__(self):
        """
        Inicializa una instancia de la clase LinerCongruentialTab.
        """
        super().__init__()
        self.xo_spinbox = self.add_input_field("Xo:")
        self.k_spinbox = self.add_input_field("k:")
        self.c_spinbox = self.add_input_field("c:")
    ...
    def get_k_spin_box_value(self):
        """
        Devuelve el valor del multiplicador (k) ingresado por el usuario.
    ...
    def get_c_spin_box_value(self):
        """
        Devuelve el valor del incremento (c) ingresado por el usuario.

        Retorna:
            int: Valor de c.
        """
        return self.c_spinbox.value()
